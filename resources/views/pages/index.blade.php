        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <h3>Ready to Power Your Project with Egeone?</h3>
                    <p>
                        Whether you’re building a solar-powered home, upgrading your industrial systems, or simply need
                        reliable backup energy — Egeone has the right battery for you. Our experts are here to guide you
                        every step of the way. Get in touch today and experience the performance, durability, and trust that
                        define Egeone Batteries.
                    </p>
                </div>
            </div>
        </div>
