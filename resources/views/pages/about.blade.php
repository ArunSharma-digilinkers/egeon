        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-12">
                    <img src="img/core-values-img.png" class="img-fluid br15">
                </div>
                <div class="col-lg-7 col-md-7 col-sm-12">
                    <div class="hm-values-box">
                        <h5>Why Choose Egeone Batteries?</h5>
                        <h3>Egeone Powers Progress — With Unmatched Quality, Trust & Innovation</h3>
                        <p>
                            Egeone Batteries stands at the forefront of energy storage solutions with a commitment to
                            quality, reliability, and innovation. Our products are engineered using advanced technology to
                            ensure peak performance in every environment — from solar-powered homes to heavy-duty industrial
                            applications. Backed by rigorous testing, expert support, and a customer-first philosophy,
                            Egeone delivers power you can depend on, every time.
                        </p>
                        <p>
                            With Egeone, you're not just buying a battery — you're investing in a long-term energy partner.
                            We offer tailored energy solutions backed by exceptional service, technical expertise, and a
                            track record of powering thousands of homes, businesses, and renewable energy projects.
                        </p>
                    </div>
                </div>
            </div>
